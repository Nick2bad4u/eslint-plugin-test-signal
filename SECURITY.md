...
- GitHub Security Advisory draft: <https://github.com/Nick2bad4u/eslint-plugin-test-signal/security/advisories/new>
...
- Keep `eslint-plugin-test-signal`, ESLint, TypeScript, and dependencies updated.
