...
describe("source plugin config wiring", () => {
    it("builds layered rule presets from src/plugin", async () => {
        ...
        expect(Object.keys(plugin.configs.recommended.rules)).toHaveLength(9);
        expect(Object.keys(plugin.configs.strict.rules)).toHaveLength(12);
        expect(Object.keys(plugin.configs.all.rules)).toHaveLength(12);
