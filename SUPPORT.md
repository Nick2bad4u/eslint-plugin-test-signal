...
Thanks for using `eslint-plugin-test-signal`.
...
2. Search existing issues:
   - <https://github.com/Nick2bad4u/eslint-plugin-test-signal/issues>
3. Open a new issue if needed:
   - <https://github.com/Nick2bad4u/eslint-plugin-test-signal/issues/new>
...
- TypeScript version
- ESLint version
- `eslint-plugin-test-signal` version
