...
`testSignal.configs.strict` includes `recommended` plus:

- `test-signal/require-negative-path`

Use this preset for libraries and core application modules where each suite
should prove at least one failure mode.
...
| [`require-error-message-assertions`](https://nick2bad4u.github.io/eslint-plugin-test-signal/docs/rules/require-error-message-assertions)         |  -  |
| [`require-negative-path`](https://nick2bad4u.github.io/eslint-plugin-test-signal/docs/rules/require-negative-path)                               |  -  |
